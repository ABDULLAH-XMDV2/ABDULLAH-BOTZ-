...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+923044975027'; // Replace this with the actual owner number
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+923044975027', '') + '+923044975027@s.whatsapp.net'], // Mention the owner
